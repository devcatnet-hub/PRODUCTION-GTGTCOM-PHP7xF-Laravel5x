@extends('masterin')
@section('title', 'Seleccionar Tema')
@section('content')
                        ...
                        @csrf
                              ...
                              <div class="form-row">
                                    ...
                                    <label for="tema">Tema:</label>
                                        ...
                                        @if ($tema->isEmpty())
                                        <option value="0">No hay temas</option>
                                        @else

                                        @foreach($tema as $temas)
                                            <option value="{{$temas->id}}">FECHA: {{$temas->fecha}} | AREA: {{$temas->responsable}} | TEMA: {{$temas->tema}}</option>
                                        @endforeach
                                        </select>
                                        @endif
                                    </div>
