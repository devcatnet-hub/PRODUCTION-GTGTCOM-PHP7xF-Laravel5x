    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-default">
                <div class="card-header"><h2 class="text-primary">{!! GetHTML::Icons('supervisor_account') !!} Nuevo Usuario</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="attrib" class="col-md-4 col-form-label text-md-right">Activo?</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="Creado" id="status" type="hidden" name="status">
