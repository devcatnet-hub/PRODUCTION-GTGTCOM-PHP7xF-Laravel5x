@extends('masterin')
@section('title', 'Nueva Template Excel para Importar Adjuntos o Datos')
@section('content')
                        ...
                        @csrf
                              ...
                              <div class="card-header border-primary">
                                  ...
                                  <h3 class="text-primary">
                                    ...
                                    Nueva Template Excel para Importar Adjuntos o Datos
                                  </h3>
                              ...
                              <div class="form-row">
                                    ...
                                    <label for="id">Tipo de adjunto o dato para importación masiva:</label>
                                        <select class="form-control" name="id" id="id">
                                            <option value="X">Escoja un tipo de adjunto o dato...</option>
                                            @foreach($objectcategory as $objectcategorys)
                                                <option value="{{$objectcategorys->id}}">{{$objectcategorys->categoria}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-row">
                                          <div class="col-md-12">
                                            ...
                                            <button type="submit" class="btn btn-primary  btn-sm">
                                                {!! GetHTML::Icons('save') !!} DOWNLOAD TEMPLATE
                                            </button>
                                          </div>
                                    </div>
