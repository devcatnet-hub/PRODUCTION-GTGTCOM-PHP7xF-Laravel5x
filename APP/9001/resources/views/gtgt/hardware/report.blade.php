@extends('masterin')
@section('title', 'Generador de reportes de Hardware')
@section('content')
                        ...
                        @csrf
                              ...
                              <div class="card-header border-primary">
                                  ...
                                  <h3 class="text-primary">
                                    ...
                                    Generador de reportes de Hardware.
                                  </h3>
                              ...
                              <div class="form-row">
                                    ...
                                    <label for="status">Estado:</label>
                                        <select class="form-control" name="status" id="status">                                            
                                            <option value="1">Hardware Asignado</option>
                                            <option value="0">Hardware Disponible</option>
                                            <option value="2">Hardware dado de Baja</option>
