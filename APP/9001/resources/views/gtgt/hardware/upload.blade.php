@extends('masterin')
@section('title', 'Importar Listado de Hardware')
@section('content')
                        ...
                        @csrf
                              ...
                              <div class="card-header border-primary">
                                  ...
                                  <h3 class="text-primary">
                                    {!! GetHTML::Icons('computer') !!}
                                    Importar Listado de Hardware
                                  </h3>
                              ...
                              <div class="card-footer border-primary">
                                    ...
                                    <div class="form-row">
                                          <div class="col-md-12">
                                            ...
                                            <a href="/gtgtdownloadtemplatehardware" class="btn btn-success btn-sm">
