                    ...
                    <form method="POST"  class="was-validated">
                        @csrf
                              ...
                              <div class="card-footer border-primary">
                                    ...
                                    <div class="form-row">
                                          <div class="col-md-12">
                                            <a href="/gtinfopersona/{{$data['idpersona']}}" class="btn btn-default btn-sm">
                              ...
                              <input id="store" type="hidden" name="store" value="0">
                              <input id="evento" type="hidden" name="evento" value="Retiro de Hardware.">
