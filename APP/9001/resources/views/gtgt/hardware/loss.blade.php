                    ...
                    <form method="POST"  class="was-validated">
                        @csrf
                              ...
                              <div class="card-footer border-primary">
                                    ...
                                    <div class="form-row">
                                          <div class="col-md-12">
                                            <a href="/gtlisthardware/0" class="btn btn-default btn-sm">
                                                {!! GetHTML::Icons('cancel') !!} CANCEL
                                            </a>
                                            <button type="submit" class="btn btn-primary  btn-sm">
                                                {!! GetHTML::Icons('remove_circle') !!} SAVE
                                            </button>
                                          </div>
                                    </div>
                              ...
                              <input id="idpersona" type="hidden" name="idpersona" value="0">
                              <input id="persona" type="hidden" name="persona" value="0">

                              <input id="idhardware" type="hidden" name="idhardware" value="{{$data['idhardware']}}">
                              <input id="store" type="hidden" name="store" value="2">
                              <input id="evento" type="hidden" name="evento" value="Retiro definitivo de Hardware.">
